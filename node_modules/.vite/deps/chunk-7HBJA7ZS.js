...
var _a3, _b, _c, _d, _e;
var SQLiteTable = class extends (_e = Table, _d = entityKind, _c = Table.Symbol.Columns, _b = InlineForeignKeys, _a3 = Table.Symbol.ExtraConfigBuilder, _e) {
  constructor() {
    super(...arguments);
    /** @internal */
...
__publicField(SQLiteTable, _d, "SQLiteTable");
/** @internal */
...
var _a9, _b2;
var SQLiteColumnBuilder = class extends (_b2 = ColumnBuilder, _a9 = entityKind, _b2) {
  constructor() {
    super(...arguments);
...
var _a10, _b3;
var SQLiteColumn = class extends (_b3 = Column, _a10 = entityKind, _b3) {
...
var _a11, _b4;
var SQLiteBigIntBuilder = class extends (_b4 = SQLiteColumnBuilder, _a11 = entityKind, _b4) {
  constructor(name) {
...
var _a12, _b5;
var SQLiteBigInt = class extends (_b5 = SQLiteColumn, _a12 = entityKind, _b5) {
  getSQLType() {
    return "blob";
  }
...
var _a13, _b6;
var SQLiteBlobJsonBuilder = class extends (_b6 = SQLiteColumnBuilder, _a13 = entityKind, _b6) {
  constructor(name) {
...
var _a14, _b7;
var SQLiteBlobJson = class extends (_b7 = SQLiteColumn, _a14 = entityKind, _b7) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(value) {
...
var _a15, _b8;
var SQLiteBlobBufferBuilder = class extends (_b8 = SQLiteColumnBuilder, _a15 = entityKind, _b8) {
  constructor(name) {
...
var _a16, _b9;
var SQLiteBlobBuffer = class extends (_b9 = SQLiteColumn, _a16 = entityKind, _b9) {
  getSQLType() {
    return "blob";
  }
};
...
var _a17, _b10;
var SQLiteCustomColumnBuilder = class extends (_b10 = SQLiteColumnBuilder, _a17 = entityKind, _b10) {
...
var _a18, _b11;
var SQLiteCustomColumn = class extends (_b11 = SQLiteColumn, _a18 = entityKind, _b11) {
  constructor(table, config) {
    super(table, config);
...
var _a19, _b12;
var SQLiteBaseIntegerBuilder = class extends (_b12 = SQLiteColumnBuilder, _a19 = entityKind, _b12) {
...
var _a20, _b13;
var SQLiteBaseInteger = class extends (_b13 = SQLiteColumn, _a20 = entityKind, _b13) {
  constructor() {
    super(...arguments);
...
var _a21, _b14;
var SQLiteIntegerBuilder = class extends (_b14 = SQLiteBaseIntegerBuilder, _a21 = entityKind, _b14) {
  constructor(name) {
...
var _a22, _b15;
var SQLiteInteger = class extends (_b15 = SQLiteBaseInteger, _a22 = entityKind, _b15) {
};
__publicField(SQLiteInteger, _a22, "SQLiteInteger");
var _a23, _b16;
var SQLiteTimestampBuilder = class extends (_b16 = SQLiteBaseIntegerBuilder, _a23 = entityKind, _b16) {
...
var _a24, _b17;
var SQLiteTimestamp = class extends (_b17 = SQLiteBaseInteger, _a24 = entityKind, _b17) {
  constructor() {
    super(...arguments);
...
var _a25, _b18;
var SQLiteBooleanBuilder = class extends (_b18 = SQLiteBaseIntegerBuilder, _a25 = entityKind, _b18) {
  constructor(name, mode) {
...
var _a26, _b19;
var SQLiteBoolean = class extends (_b19 = SQLiteBaseInteger, _a26 = entityKind, _b19) {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", this.config.mode);
  }
...
var _a27, _b20;
var SQLiteNumericBuilder = class extends (_b20 = SQLiteColumnBuilder, _a27 = entityKind, _b20) {
  constructor(name) {
...
var _a28, _b21;
var SQLiteNumeric = class extends (_b21 = SQLiteColumn, _a28 = entityKind, _b21) {
  getSQLType() {
    return "numeric";
  }
};
...
var _a29, _b22;
var SQLiteRealBuilder = class extends (_b22 = SQLiteColumnBuilder, _a29 = entityKind, _b22) {
  constructor(name) {
...
var _a30, _b23;
var SQLiteReal = class extends (_b23 = SQLiteColumn, _a30 = entityKind, _b23) {
  getSQLType() {
    return "real";
  }
};
...
var _a31, _b24;
var SQLiteTextBuilder = class extends (_b24 = SQLiteColumnBuilder, _a31 = entityKind, _b24) {
...
var _a32, _b25;
var SQLiteText = class extends (_b25 = SQLiteColumn, _a32 = entityKind, _b25) {
  constructor(table, config) {
    super(table, config);
...
var _a33, _b26;
var SQLiteTextJsonBuilder = class extends (_b26 = SQLiteColumnBuilder, _a33 = entityKind, _b26) {
  constructor(name) {
...
var _a34, _b27;
var SQLiteTextJson = class extends (_b27 = SQLiteColumn, _a34 = entityKind, _b27) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(value) {
...
var _a36, _b28;
var SQLiteDeleteBase = class extends (_b28 = QueryPromise, _a36 = entityKind, _b28) {
...
var _a38, _b29;
var SQLiteInsertBase = class extends (_b29 = QueryPromise, _a38 = entityKind, _b29) {
...
var _a39, _b30;
var SQLiteViewBase = class extends (_b30 = View, _a39 = entityKind, _b30) {
};
...
var SQLiteDialect = class {
  ...
  buildUpdateSet(table, set) {
    ...
    const columnNames = Object.keys(tableColumns).filter(
      (colName) => {
        var _a68;
        return set[colName] !== void 0 || ((_a68 = tableColumns[colName]) == null ? void 0 : _a68.onUpdateFn) !== void 0;
      }
    );
...
var _a41, _b31;
var SQLiteSyncDialect = class extends (_b31 = SQLiteDialect, _a41 = entityKind, _b31) {
...
var _a42, _b32;
var SQLiteAsyncDialect = class extends (_b32 = SQLiteDialect, _a42 = entityKind, _b32) {
...
var _a45, _b33;
var SQLiteSelectQueryBuilderBase = class extends (_b33 = TypedQueryBuilder, _a45 = entityKind, _b33) {
...
var _a46, _b34;
var SQLiteSelectBase = class extends (_b34 = SQLiteSelectQueryBuilderBase, _a46 = entityKind, _b34) {
  constructor() {
    super(...arguments);
    __publicField(this, "run", (placeholderValues) => {
      return this._prepare().run(placeholderValues);
...
var _a49, _b35;
var SQLiteUpdateBase = class extends (_b35 = QueryPromise, _a49 = entityKind, _b35) {
...
var _a51, _b36;
var SQLiteRelationalQuery = class extends (_b36 = QueryPromise, _a51 = entityKind, _b36) {
...
var _a52, _b37;
var SQLiteSyncRelationalQuery = class extends (_b37 = SQLiteRelationalQuery, _a52 = entityKind, _b37) {
  sync() {
    return this.executeRaw();
  }
};
...
var _a53, _b38;
var SQLiteRaw = class extends (_b38 = QueryPromise, _a53 = entityKind, _b38) {
...
var _a60, _b39;
var ExecuteResultSync = class extends (_b39 = QueryPromise, _a60 = entityKind, _b39) {
...
var _a63, _b40;
var SQLiteTransaction = class extends (_b40 = BaseSQLiteDatabase, _a63 = entityKind, _b40) {
...
var _a65, _b41;
var ViewBuilder = class extends (_b41 = ViewBuilderCore, _a65 = entityKind, _b41) {
  as(qb) {
    if (typeof qb === "function") {
      qb = qb(new QueryBuilder());
    }
...
var _a66, _b42;
var ManualViewBuilder = class extends (_b42 = ViewBuilderCore, _a66 = entityKind, _b42) {
...
var _a67, _b43, _c2;
var SQLiteView = class extends (_c2 = SQLiteViewBase, _b43 = entityKind, _a67 = SQLiteViewConfig, _c2) {
  constructor({ sqliteConfig, config }) {
    super(config);
    /** @internal */
    __publicField(this, _a67);
    this[SQLiteViewConfig] = sqliteConfig;
  }
};
__publicField(SQLiteView, _b43, "SQLiteView");
...
//# sourceMappingURL=chunk-7HBJA7ZS.js.map
