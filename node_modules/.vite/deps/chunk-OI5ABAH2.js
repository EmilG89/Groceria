...
__publicField(Subquery, _a4, "Subquery");
var _a5, _b2;
var WithSubquery = class extends (_b2 = Subquery, _a5 = entityKind, _b2) {
};
__publicField(WithSubquery, _a5, "WithSubquery");
...
var _a6, _b3, _c2, _d2;
var PgTable = class extends (_d2 = Table, _c2 = entityKind, _b3 = InlineForeignKeys, _a6 = Table.Symbol.ExtraConfigBuilder, _d2) {
  constructor() {
    super(...arguments);
    /**@internal */
...
var _a12, _b4;
var PgColumnBuilder = class extends (_b4 = ColumnBuilder, _a12 = entityKind, _b4) {
  constructor() {
    super(...arguments);
...
var _a13, _b5;
var PgColumn = class extends (_b5 = Column, _a13 = entityKind, _b5) {
  constructor(table, config) {
...
var _a14, _b6;
var ExtraConfigColumn = class extends (_b6 = PgColumn, _a14 = entityKind, _b6) {
  constructor() {
    super(...arguments);
...
var _a16, _b7;
var PgArrayBuilder = class extends (_b7 = PgColumnBuilder, _a16 = entityKind, _b7) {
...
var _a17, _b8;
var _PgArray = class _PgArray extends (_b8 = PgColumn, _a17 = entityKind, _b8) {
...
var _a18, _b9;
var PgEnumColumnBuilder = class extends (_b9 = PgColumnBuilder, _a18 = entityKind, _b9) {
...
var _a19, _b10;
var PgEnumColumn = class extends (_b10 = PgColumn, _a19 = entityKind, _b10) {
  constructor(table, config) {
    super(table, config);
...
function mergeQueries(queries) {
  ...
  for (const query of queries) {
    ...
    if ((_a39 = query.typings) == null ? void 0 : _a39.length) {
      if (!result.typings) {
        result.typings = [];
      }
  ...
  buildQueryFromSourceParams(chunks, _config) {
    ...
    return mergeQueries(chunks.map((chunk) => {
      ...
      if (isSQLWrapper(chunk)) {
        if ((_a39 = chunk.shouldOmitSQLParens) == null ? void 0 : _a39.call(chunk)) {
...
((SQL2) => {
  ...
  __publicField(_Aliased, _a39, "SQL.Aliased");
...
var _a26, _b11;
_b11 = entityKind, _a26 = ViewBaseConfig;
var View = class {
...
__publicField(PrimaryKeyBuilder, _a27, "PgPrimaryKeyBuilder");
var _a28;
_a28 = entityKind;
...
__publicField(PrimaryKey, _a28, "PgPrimaryKey");
...
__publicField(Relation, _a29, "Relation");
var _a30;
_a30 = entityKind;
var Relations = class {
  constructor(table, config) {
...
__publicField(Relations, _a30, "Relations");
var _a31, _b12;
var _One = class _One extends (_b12 = Relation, _a31 = entityKind, _b12) {
...
__publicField(_One, _a31, "One");
var One = _One;
var _a32, _b13;
var _Many = class _Many extends (_b13 = Relation, _a32 = entityKind, _b13) {
...
function extractTablesRelationalConfig(schema, configHelpers) {
  ...
  for (const [key, value] of Object.entries(schema)) {
    if (is(value, Table)) {
      ...
      const extraConfig = (_a39 = value[Table.Symbol.ExtraConfigBuilder]) == null ? void 0 : _a39.call(value, value[Table.Symbol.ExtraConfigColumns]);
      if (extraConfig) {
...
var _a36, _b14;
_b14 = entityKind, _a36 = Symbol.toStringTag;
...
var _a37, _b15;
var DrizzleError = class extends (_b15 = Error, _a37 = entityKind, _b15) {
...
var _a38, _b16;
var TransactionRollbackError = class extends (_b16 = DrizzleError, _a38 = entityKind, _b16) {
  constructor() {
...
//# sourceMappingURL=chunk-OI5ABAH2.js.map
